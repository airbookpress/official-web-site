...
function update_notifier_menu() {  
	...
	$theme_data = wp_get_theme('tob'); 
	
	if(isset($theme_data['Version']) && version_compare($theme_data['Version'], $xml->latest) == -1) {
		add_dashboard_page($theme_data['Name'].__('主题更新', 'haoui'), $theme_data['Name'].__('主题更新', 'haoui').'<span class="update-plugins count-1"><span class="update-count">'.$xml->latest.'</span></span>', 'administrator', $theme_data['Name'].'-update','update_notifier');
	}
}  
...
function update_notifier() { 
	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px;">
            ...
            <br>
            <p><a class="button-primary" target="_blank" href="https://themebetter.com/member">获取主题<?php echo $xml->latest; ?>版本</a> <a class="button" target="_blank" href="https://themebetter.com/member/workorder">工单支持</a></p>
        </div>
...
function get_latest_theme_version() {
	...
	$notifier_file_url = 'https://themebetter.com/tm/laEXQg/update';
	
	$db_cache_field = 'tob-notifier-cache';
